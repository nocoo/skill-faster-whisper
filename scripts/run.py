#!/usr/bin/env python3
"""
Universal runner for Faster Whisper skill
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("\nAvailable scripts:")
        print("  transcribe.py  - Transcribe audio files")
        print("\nQuick start:")
        print("  python scripts/run.py transcribe.py audio.mp3")
        print("  python scripts/run.py transcribe.py audio.mp3 --language zh --output result.txt")
        sys.exit(1)
